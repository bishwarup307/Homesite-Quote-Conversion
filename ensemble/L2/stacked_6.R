...
valm <- read_csv("The Quants/validation_merged2.csv")
testm <- read_csv("The Quants/test_merged2.csv")
kf <- read_csv("./Data/KFold.csv")
...
selectedCols <- c("QuoteNumber", "int_1", "SalesField5", "L2_int_4", "L2_int_2", "L3_int_2", "L3_int_1", "PersonalField9",
                  ...
                  "CoverageField8", "int_11", "PersonalField26", "int_10", "SalesField6", "int_5", "CoverageField11B", "Field9", "SalesField2A", "SalesField2B",
                  "GeographicField8A", "Field10", "Field11", "PersonalField84", "GeographicField6B", "Nac", "PropertyField8", "SalesField3",
                  "SalesField11", "GeographicField7A", "GeographicField20A", "SalesField10", "PersonalField15", "CoverageField9",
                  "PropertyField35", "GeographicField12A", "CoverageField11A", "GeographicField20B", "GeographicField41A")
...
write_csv(df, "./Submissions/stacked_6.csv")
